...
using namespace std;
    ...
    const handleFullScreen = () => {
        if (screenSize === 'Full Screen') {
            ...
            document.getElementById('b1').classList.add('full')
            document.getElementById('b2').classList.add('full')
        }
        else {
            ...
            document.getElementById('b1').classList.remove('full')
            document.getElementById('b2').classList.remove('full')
    ...
    return (
        ...
        <div>
            ...
            <div className="d-flex" id='bigbox'>
                <div className='border box1' id='b1' >
                ...
                <div className='border box2' id='b2'>
